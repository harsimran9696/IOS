...
//        movieTableView.dataSource=self
    ...
    movies = database.selectAllMovies()
        tableView.register(MovieUITableViewCell.self , forCellReuseIdentifier: "cell")
    ...
    {
    let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! MovieUITableViewCell
      //  let movie =
        
        cell.titleLabel.text = movies[indexPath.row].name
        cell.subTitleLbl.text = String(movies[indexPath.row].year)
