...
class SQLiteDatabase
{
    ...
    insertWithQuery(insertStatementQuery, bindingFunction:{(insertStatement) in sqlite3_bind_text(insertStatement, 1, NSString(string: movie.name).utf8String, -1, nil)
  ...
  /*  func SEL(<#parameters#>) -> <#return type#> {
        <#function body#>
    }*/
    ...
    {
        var result = Movie(ID:0,name:"a",year:0,director:"a")
